...
<button onclick="loadExample('up1vga10x8', true);">uP1 + VGA 7.5x10 + ASM</button>
<button onclick="loadExample('up1vga20x15');">uP1 + VGA 20x15</button>
<button onclick="loadExample('vgamem8');">VGA 20x15 + RAM (8 bits)</button>
<button onclick="loadExample('vgamem32');">VGA 20x15 + RAM (32 bits)</button>
<button onclick="loadExample('hexcount');">Hex Count</button> 
<button onclick="loadExample('demo');">Demo</button>
