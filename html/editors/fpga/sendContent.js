...
function savefiles () {
	...
	var asm_content = asmeditor.getValue();
	...
	request.send('cpp_content=' + encodeURIComponent(cpp_content) + '&asm_content=' + encodeURIComponent(asm_content)); //send the value of the editor by using the the encodeURIComponent funtion
}
