...
<p>Clicking the Options button on the navigation bar or clicking the navigation bar itself will open the calendar's Options Panel. On this panel you can select:</p>
...
<p>After having made your choices, the Options button in the navigation bar or the navigation bar itself should be clicked again to activate your choices.</p> 
...
<p>Click the side menu button on the right side of the navigation bar and select "Search" to open the Text Search page. This page contains detailed instructions regarding the use of the search function.</p>
<br></li>
<?php if ($usr['privs'] > 1) { //if post rights ?>
<li id="ae"><h3>Add / Edit / Delete Event</h3>
...
<p>When a user logs in with administrator rights, the side menu on the right side in the navigation bar will contain several administrator options. Via this menu the following administrator pages can be selected:</p>
<br>
<ol type='a'>
