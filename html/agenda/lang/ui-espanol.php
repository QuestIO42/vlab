...
"evt_to" => "A",
"evt_not_help" => "Lista de direcciones de destinatarios separadas por punto y coma. La dirección de un destinatario puede ser un nombre de usuario, una dirección de correo electrónico, un número de teléfono móvil o, entre corchetes, el nombre de un archivo con direcciones en el directorio \'reciplists \', con una dirección (un nombre de usuario, una dirección de correo electrónico o un número de teléfono móvil) por línea. Cuando se omite, la extensión de archivo predeterminada es .txt. <br> Longitud máxima del campo: 255 caracteres.",
"evt_eml_help" => "A menos que se termine con un signo $, los números de teléfono móvil se utilizarán para encontrar la dirección de correo electrónico correspondiente en la base de datos. Si no se encuentra, no se enviará ningún correo electrónico a este destinatario.",
"evt_sms_help" => "A menos que se termine con un signo $, las direcciones de correo electrónico se utilizarán para encontrar el número de teléfono móvil correspondiente en la base de datos. Si no se encuentra, no se enviará ningún SMS a este destinatario.",
...
"evt_descr_help_url" => "• Los enlaces URL en el siguiente formato: \'url\' o\'url [nombre]\', donde\'nombre\' será el título del enlace. P.ej. https://www.google.com [búsqueda].",
...
"vws_download_title" => "Descarga un archivo de texto con estos eventos.",
"vws_send_mail" => "Enviar correo",
"vws_send_mail_to" => "Enviar correo a",
...
//alert.php
"alt_message#0" => "Si no usa el calendario, ¡su sesión expirará pronto!",
