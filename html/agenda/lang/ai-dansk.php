...
"lookBackAhead_label" => "Dage der skal ses tilbage/fremad",
"lookBackAhead_text" => "Antal dage der skal ses tilbage i Opgavelisten og fremad i visningen Kommende begivenheder, Opgavelisten og RSS feeds.",
...
"evtHeadX_label" => "Event skabelon i Måneds, uge og dag visning",
"evtHeadX_text" => "Skabelon med pladsholder der angiver hvilke event-felter der skal vises . Følgende pladsholdere kan bruges:<br>#ts - start tidspunkt<br>#tx - start og slut tidspunkt<br>#e - event titel<br>#o - event ejer/owner<br>#v - Sted<br>#lv - sted med ledetekst \'Sted:\' foran<br>#c - Kategori<br>#lc - Kategori med ledetekst \'Kategori:\' foran<br>#a - alder (se note nedenfor)<br>#x1 - Ekstra felt 1<br>#lx1 - Ekstra felt 1 med ledetekst fra Settings-siden foran<br>#x2 - Ekstra felt 2<br>#lx2 - Ekstra felt 2 med ledetekst fra Settings-siden foran<br>#/ - Ny linie<br>Felterne vises i angivet orden. Andre karakterer end pladsholderne vil vises som de er og vil være del af den viste event.<br>HTML-tags er tilladte i skabelonen. Eksempelvis &lt;b&gt;#e&lt;/b&gt;.<br> | Karakteren kan bruges til at opsplitte i sektioner. Hvis der indenfor en sektion med en #-parameter vil blive en tom streng, vil hele sektionen blive udeladt.<br>Note: Alderen bliver vist hvis der på en event er benyttet en kategori med  \'Repeat\' set to \'every year\' og årstallet for fødslen er angivet i paranteser. Fødselsåret i parantes kan angives hvorsomhelst i eventbeskrivelsen.",
"monthView" => "Måneds visning",
"wkdayView" => "Uge/Dag visning",
...
"maxEmlCc_text" => "Normalt tillader ISPer et maximum antal modtagere pr. email. Hvis man sender emails med et større antal modtagere end angivet her, vil emailen blive splittet op i flere email, hver med det angivne antal max modtagere.",
...
"mdb_no_bup_match" => "Backupfil stemte ikke overens med kalender version.<br>Database blev ikke restored.",
