...
"defaultViewL_label" => "Başlangıçtaki Görünüm Şekli (large display)",
"defaultViewL_text" => "Default calendar view on startup for public and logged-in users using large displays. P<br>Önerilen: Ay",
"defaultViewS_label" => "Başlangıçtaki Görünüm Şekli (small display)",
"defaultViewS_text" => "Default calendar view on startup for public and logged-in users using small displays. P<br>Önerilen: Yaklaşan etkinlikler",
...
"lookBackAhead_label" => "Gelecek kaç Günlük Gösterilsin",
"lookBackAhead_text" => "Gelecek randevularının kaç günlük gösterileceğini giriniz.",
...
"showImgInMV_label" => "Aylık görünümde linkleri göster",
...
"log_pw_subject" => "Sizin Parola",
"log_npw_subject" => "Sizin Yeni Parola",
...
"cat_seq_in_menu" => "Sıralama Menüdeki",
"cat_cat_color" => "Kategori Renk",
"cat_text" => "Yazı",
"cat_background" => "Arkaplan",
...
"grp_priv0" => "Giriş Yasak",
"grp_priv1" => "Ajanda Görünümü",
"grp_priv2" => "Sadece Kendi için Olay Ekle/Düzenle",
"grp_priv3" => "Olay Ekle/Düzenle",
"grp_priv4" => "Ekle/Düzenle + manager",
"grp_priv9" => "Yönetici Fonksiyonları",
