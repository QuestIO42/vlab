...
"availViews_text" => "Calendar views available to public and logged-in users specified by means of a comma-separated list with view numbers. Meaning of the numbers:<br>1: year view<br>2: month view (7 days)<br>3: work month view<br>4: week view (7 days)<br>5: work week view<br>6: day view<br>7: upcoming events view<br>8: changes view<br>9: matrix view (categories)<br>10: matrix view (users)<br>11: gantt chart view",
...
"privEvents_text" => "Private events are only visible to the user who entered the event.<br>Enabled: users can enter private events.<br>Default: when adding new events, the \'private\' check box in the Event window will be checked by default.<br>Always: when adding new events they will always be private, the \'private\' check-box in the Event window will not be shown.",
"aldDefault_label" => "New events all-day by default",
"aldDefault_text" => "When adding events, in the Event window the \'All day\' check-box will be checked by default. In addition, if no start time is specified the event automatically becomes an all-day event.",
...
"dwTsHeight_text" => "Number of pixels for each time slot in Day/Week view.",
...
"weekNumber_text" => "Displaying week numbers in the relevant views can be enabled/disabled",
...
"calPhone_text" => "The phone number is used as sender ID when sending SMS notification messages.<br>Format: free, max. 20 digits (some countries require a telephone number, other countries also accept alphabetic characters).<br>If no SMS service is active or if no SMS subject template has been defined, this field may be blank.",
...
"log_pw_subject" => "Your Password",
"log_npw_subject" => "Your New Password",
"log_npw_sent" => "Your new password has been sent",
"log_registered" => "Registration successful - Your password has been sent to you by email",
...
"log_dm_invalid" => "Invalid domain address",
...
"grp_priv0" => "No access",
"grp_priv1" => "View calendar",
"grp_priv2" => "Post/edit own events",
"grp_priv3" => "Post/edit all events",
