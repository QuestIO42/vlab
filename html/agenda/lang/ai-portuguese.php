...
"calEmail_text" => "The email address used to receive contact messages and to send or receive notification emails.<br>Formato: \'e-mail\' ou \'nome &#8826;e-mail&#8827;\'. \'nome\' pode ser o nome da agenda.",
...
"defaultViewL_label" => "Vista por defeito (large display)",
"defaultViewL_text" => "Default calendar view on startup for public and logged-in users using large displays. <br>Escolha recomendada: Mês.",
"defaultViewS_label" => "Vista por defeito (small display)",
"defaultViewS_text" => "Default calendar view on startup for public and logged-in users using small displays. <br>Escolha recomendada: Próximos.",
...
"lookBackAhead_label" => "Dias a exibir",
"lookBackAhead_text" => "Número de dias para exibir após um evento na vista Próximos Eventos, in the Todo List and in the RSS feeds.",
...
"showImgInMV_label" => "Mostrar na vista 'Mensal'",
...
"weekNumber_text" => "O número de semanas, nas vistas relevantes, podem ser exibidas ou não",
...
"chgSummary_text" => "Número de dias anteriores à modificação do calendário.<br>Usado pelo script sendchg.php",
...
"log_pw_subject" => "Sua senha",
"log_npw_subject" => "Sua nova senha",
...
"cat_cat_name" => "Nome da Categoria",
"cat_symbol" => "Symbol",
...
"cat_seq_in_menu" => "Sequência no menu",
"cat_cat_color" => "Cor da Categoria",
"cat_text" => "Texto",
...
"grp_priv0" => "Nenhum Privilégio de acesso",
"grp_priv1" => "Visualizar",
"grp_priv2" => "Post/editar próprio",
"grp_priv3" => "Post/editar todos",
"grp_priv4" => "Post/editar + manager",
"grp_priv9" => "Funções de administrador",
...
//explanations
"xpl_manage_db" =>
"<h3>Instruções para Gerir Base de Dados</h3>
<p>Nesta página, as seguintes funções podem ser selecionadas:</p>
<h6>Compactar Base de Dados</h6>
...
<h6>Cópia de Segurança da Base de Dados</h6>
...
<strong>ficheiros/</strong> com o nome: <kbd>dump-cal-lcv-aaaammdd-hhmmss.sql</kbd> 
(onde 'cal' = calendar ID, 'lcv' = calendar version e 'aaaammdd-hhmmss' = ano, mês, dia, 
horas, minutos and segundos).</p>
...
"xpl_import_csv" =>
"<h3>Instruções para importar CSV</h3>
...
"xpl_import_ical" =>
"<h3>Instruções para importar iCalendar</h3>
...
<h6>Exemplo do ficheiro iCal</h6>
...
"xpl_export_ical" =>
"<h3>Instruções para exportar iCalendar</h3>
